...
public class ComputerActivity extends AppCompatActivity {
    ...
    private ComputerQuestions mComputerQuestions = new ComputerQuestions();
    ...
    private int mComputerQuestionsLength = mComputerQuestions.mComputerQuestions.length;
    Random r;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateQuestions(r.nextInt(mComputerQuestionsLength));
            ...
            if(btnPressed>=10){
                ...
                builder.setTitle("Result").setMessage(userName+" have " +mScore+" marks. According to your Marks. "+userName+ " is " +grade)
                        ...
                        .setNegativeButton("Select Subject", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Intent intent = new Intent(ComputerActivity.this,CategoryActivity.class);
                                intent.putExtra("email",userName);
                                startActivity(intent);
                            }
                        });
    ...
    private void updateQuestions(int num) {
        ...
        question.setText(mComputerQuestions.getQuestion(num));
        mOption1.setText(mComputerQuestions.getChoice1(num));
        mOption2.setText(mComputerQuestions.getChoice2(num));
        mOption3.setText(mComputerQuestions.getChoice3(num));
        mOption4.setText(mComputerQuestions.getChoice4(num));

        mAnswer = mComputerQuestions.getCorrectAnswers(num);
